...
![车和它的朋友们（左一站立）](./index.assets/车和它的朋友们（左一站立）.webp)
...
![openfunction-architecture](./index.assets/openfunction-architecture.svg)
...
<img 
  src="./index.assets/serverless.webp" 
  style="display: block; margin: 15px auto; width: 60%;" 
  alt="Serverless"
/>
...
![花水湾](./index.assets/花水湾.webp)

![西岭雪山，感谢出镜的大哥](./index.assets/西岭雪山.webp)
